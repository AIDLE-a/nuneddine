...
export const MOCK_STOCKS = [
  {
    ...
    news: [
      { title: "삼성전자, HBM4 양산 일정 앞당겨", source: "한국경제", url: "#", published_at: "2시간 전", sentiment: "positive" },
      { title: "메모리 반도체 수요 둔화 우려 재부각", source: "매일경제", url: "#", published_at: "5시간 전", sentiment: "negative" },
      { title: "외국인 순매수 3거래일 연속 이어져", source: "연합뉴스", url: "#", published_at: "어제", sentiment: "positive" },
    ],
  ...
  },
  {
    ...
    news: [
      { title: "SK하이닉스, AI 메모리 수요 급증 수혜", source: "한국경제", url: "#", published_at: "1시간 전", sentiment: "positive" },
      { title: "HBM3E 엔비디아 독점 공급 계획", source: "서울경제", url: "#", published_at: "3시간 전", sentiment: "positive" },
      { title: "외국인 기관 동반 순매수 지속", source: "연합뉴스", url: "#", published_at: "어제", sentiment: "positive" },
    ],
  ...
  },
  {
    ...
    news: [
      { title: "Tesla EV demand slowing in Europe", source: "Reuters", url: "#", published_at: "2h ago", sentiment: "negative" },
      { title: "Musk hints at new affordable model", source: "Bloomberg", url: "#", published_at: "5h ago", sentiment: "positive" },
      { title: "Tesla China sales drop 15% MoM", source: "WSJ", url: "#", published_at: "yesterday", sentiment: "negative" },
    ],
  ...
  },
  {
    ...
    news: [
      { title: "Apple Intelligence AI features expand", source: "TechCrunch", url: "#", published_at: "1h ago", sentiment: "positive" },
      { title: "iPhone demand mixed across markets", source: "FT", url: "#", published_at: "4h ago", sentiment: "negative" },
      { title: "Services revenue hits all-time high", source: "CNBC", url: "#", published_at: "yesterday", sentiment: "positive" },
    ],
