              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ position: 'relative', marginBottom: 32 }}>
                  ...
                  <div style={{ height: 12, borderRadius: 6, background: 'linear-gradient(90deg, #fee2e2, #fef9c3, #dcfce7)', position: 'relative' }}>
                    {/* 현재가 마커 */}
                    <div style={{
                      position: 'absolute', left: `${currentPos}%`, top: '50%',
                    ...
                    {/* 평균 목표주가 마커 */}
                    <div style={{
                      position: 'absolute', left: `${meanPos}%`, top: '50%',
                      transform: 'translate(-50%, -50%)',
                      width: 18, height: 18, borderRadius: '50%',
                      background: '#8B5CF6', border: '3px solid #fff',
                      boxShadow: '0 2px 6px rgba(139,92,246,0.4)', zIndex: 2
                    }} />
                  </div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
                    <div style={{ textAlign: 'left' }}>
                      <p style={{ margin: 0, fontSize: 10, color: '#EF4444', fontWeight: 600 }}>최저</p>
                      <p style={{ margin: 0, fontSize: 12, fontWeight: 700, color: '#374151' }}>{fmt(low)}</p>
                    </div>
                    <div style={{ textAlign: 'center' }}>
                      <p style={{ margin: 0, fontSize: 10, color: '#8B5CF6', fontWeight: 600 }}>평균</p>
                      <p style={{ margin: 0, fontSize: 12, fontWeight: 700, color: '#8B5CF6' }}>{fmt(mean)}</p>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <p style={{ margin: 0, fontSize: 10, color: '#10B981', fontWeight: 600 }}>최고</p>
                      <p style={{ margin: 0, fontSize: 12, fontWeight: 700, color: '#374151' }}>{fmt(high)}</p>
                    </div>
                  </div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        {item.upside != null && (
                          <span style={{ fontSize: 11, padding: '2px 8px', borderRadius: 10,
                            background: item.upside >= 0 ? '#dcfce7' : '#fee2e2',
                            color: item.upside >= 0 ? '#16a34a' : '#dc2626', fontWeight: 600 }}>
